...
1. Если спрашивают "можно ли использовать all ночью?" - ответь: "Согласно пункту 6.1 правил, команда all (упоминание всех) запрещена с 00:00 до 08:00 по МСК. За это дают мут на 60-120 минут. Лучше не рисковать! ⚠️"
